...
export default class OrionToggleButtonGroupSetupService extends SharedSetupService {
	...
	constructor (
		...
		& Omit<typeof OrionToggleButtonGroupSetupService.defaultProps, 'childProps'>
		& { childProps?: Partial<OrionToggleButtonProps> },
