import { SharedProps, type SharedPropsSize } from '../../Shared/SharedProps';
...
export type OrionCardProps = SharedPropsSize & {
...
export class OrionCardSetup extends SharedSetup {
	...
	constructor (
		protected props: OrionCardProps & typeof OrionCardSetup.defaultProps,
