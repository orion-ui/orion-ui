<template>
	<div class="flex g-16">
		<o-button @click="_asideA?.open()">
			Show aside with actions
		</o-button>

		<o-button @click="_asideB?.open()">
			Show aside with footer
		</o-button>
		...
		<o-aside
			...
			<template #header>
				<div><span class="text--primary">Here</span> comes your <span class="text--primary">header slot content</span></div>
			</template>
