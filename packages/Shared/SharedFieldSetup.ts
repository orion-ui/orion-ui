...
export type SharedFieldSetupProps =
...
export default abstract class SharedFieldSetup<P, T, E extends SharedFieldSetupEmits = SharedFieldSetupEmits> extends SharedSetup {
