import { SharedProps, type SharedPropsColor, type SharedPropsPrefixIcon, type SharedPropsSuffixIcon } from 'packages/Shared/SharedProps';
...
export type OrionToggleButtonProps = SharedPropsColor & SharedPropsPrefixIcon & SharedPropsSuffixIcon & {
...
export class OrionToggleButtonSetup extends SharedSetup {
	...
	constructor (
		protected props: OrionToggleButtonProps & typeof OrionToggleButtonSetup.defaultProps,
