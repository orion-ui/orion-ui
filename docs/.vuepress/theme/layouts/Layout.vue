<template>
	<div
		...
		<main class="doc-content">
			...
			<Content v-else/>
			<page-nav v-if="!frontmatter.home"/>
			<page-meta v-if="!frontmatter.home"/>
			<div class="footer">
				<span>
					<a
						href="https://choosealicense.com/licenses/mit/"
						target="_blank">MIT Licensed</a>
					| Copyright © 2023-present Orion UI
				</span>
			</div>
		</main>

		<table-of-content v-if="!useResponsive().onPhone && shouldShowToc"/>
	</div>
	<tour-doc/>
	<tour-props/>
</template>
...
import { getUid, setAppLang, setThemeMode, useResponsive } from '@/lib';
