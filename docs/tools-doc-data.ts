...
const toolsDocData = {
			...
			highlightDomElement: {"description":"hightlights an element of the DOM","return":"void","param":[{"name":"element","type":"HTMLElement | string | null","description":"element to highlight"},{"name":"event","type":"MouseEvent","description":"event to trigger the highlight"}]},
